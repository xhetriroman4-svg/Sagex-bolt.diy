    ...
    if (
      ...
      return new Response(
        JSON.stringify({
          ...errorResponse,
          message:
            'API rate limit exceeded. Your API key has reached its request limit. Please wait 1-2 minutes before trying again, or check your API provider dashboard for quota details.',
          statusCode: 429,
          isRetryable: true,
